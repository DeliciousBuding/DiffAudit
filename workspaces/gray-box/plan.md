...
12. 当前 `TMIA-DM` 已完成最小 `protocol probe`、一次 repeat、same-split 比较、late-window refine，以及首个正向 `GPU128` rung；下一条 GPU 任务应是 repeat-confirmation，而不是直接宣布替代 `PIA`
