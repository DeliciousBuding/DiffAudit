...
12. 当前 `TMIA-DM` 已完成最小 `protocol probe`、一次 repeat、same-split 比较、late-window refine、两次正向 `GPU128` rung，以及一个正向 `GPU256` rung；结论是该线已成为稳定 GPU challenger，但 headline 决定仍待更明确比较
