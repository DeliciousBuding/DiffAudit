...
12. 当前 `TMIA-DM` 已完成最小 `protocol probe`、一次 repeat、same-split 比较、以及 late-window refine；结论是 late-window `long_window` 已经具备最小 GPU pilot 资格，但还没有足够证据替代 `PIA` 主线
