...
$$\begin{split} \|\epsilon_t - \epsilon_\theta(x_t, t)\|^2 &= (\epsilon_t - \epsilon_\theta(x_t, t))^\top \left(\epsilon_t - \epsilon_\theta(x_t, t)\right) \\ &= \|\epsilon_t\|^2 - 2\epsilon_t^\top \epsilon_\theta(x_t, t) + \|\epsilon_\theta(x_t, t)\|^2 \end{split}$$

Then, we proceed to compute the derivatives of each of the three expanded terms with respect to :

<span id="page-3-2"></span>
$$\nabla_{\theta} L_{t}(\theta, x) = \nabla_{\theta} \left( \|\epsilon_{t}\|^{2} - 2\epsilon_{t}^{\mathsf{T}} \epsilon_{\theta}(x_{t}, t) + \|\epsilon_{\theta}(x_{t}, t)\|^{2} \right)$$

$$= \nabla_{\theta} \|\epsilon_{t}\|^{2} - 2\nabla_{\theta} \left( \epsilon_{t}^{\mathsf{T}} \epsilon_{\theta}(x_{t}, t) \right) + \nabla_{\theta} \|\epsilon_{\theta}(x_{t}, t)\|^{2}$$

$$= 0 - 2\epsilon_{t}^{\mathsf{T}} \nabla_{\theta} \epsilon_{\theta}(x_{t}, t) + 2\epsilon_{\theta}(x_{t}, t)^{\mathsf{T}} \nabla_{\theta} \epsilon_{\theta}(x_{t}, t)$$

$$= -2 \left( \epsilon_{t} - \epsilon_{\theta}(x_{t}, t) \right)^{\mathsf{T}} \nabla_{\theta} \epsilon_{\theta}(x_{t}, t)$$

$$= 2 \left( \epsilon_{\theta}(x_{t}, t) - \epsilon_{t} \right)^{\mathsf{T}} \nabla_{\theta} \epsilon_{\theta}(x_{t}, t)$$
...
#### <span id="page-5-2"></span>Algorithm 1 GSA1
...
6: 
$$\bar{L} \leftarrow \frac{1}{|K|} \sum_{t \in K} L_t$$
...
#### <span id="page-5-1"></span>Algorithm 2 GSA2
...
8: 
$$\mathcal{G} \leftarrow \frac{1}{|K|} \sum_{t \in K} \mathcal{G}_t$$
...
<span id="page-6-3"></span>Table 4: Existing white-box attacks on the CIFAR-10 dataset are benchmarked using four distinct metrics. LiRA\* , LSA\* , GSA1, and GSA2 are all obtained under the same conditions.
...
To further demonstrate that the optimal timestep for distinguishing between member and non-member samples using loss varies
...
<span id="page-10-2"></span>Table 5: The table presents the performance results of GSA1 and GSA2, trained on three different datasets and evaluated using four distinct evaluation metrics.
...
We thank the reviewers for their valuable comments and suggestions. This work is partially supported by NSF CNS-2350332, CNS-2350333, OAC-2319988.
...
$$\tilde{\pmb{\mu}}(x_t,x_0) = \frac{1}{\sqrt{\alpha_t}}(x_t - \frac{\beta_t}{\sqrt{1-\bar{\alpha}_t}}\epsilon_t)$$
...
$$x_{t-1}' = \sqrt{\bar{\alpha}_{t-1}} f_{\theta}(x_t',t) + \sqrt{1 - \bar{\alpha}_{t-1} - \sigma_t^2} \cdot \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) + \sigma_t \epsilon_{\theta}(x_t',t) +$$
