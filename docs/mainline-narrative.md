...
3.4 用 [2026-04-10-finding-nemo-activation-only-canary-sketch](../workspaces/white-box/2026-04-10-finding-nemo-activation-only-canary-sketch.md) 固定未来实现草案的边界，而不是默认把它写成已开始实现
