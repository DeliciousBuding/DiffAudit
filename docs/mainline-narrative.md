...
2. 按 [2026-04-10-rtx4070-8gb-long-horizon-plan](../workspaces/implementation/2026-04-10-rtx4070-8gb-long-horizon-plan.md) 先把单卡 GPU 用在 `PIA` 当前主线支持任务：
2.1 `8GB-safe portability ladder`
2.2 `defense-cost frontier`
3. 用 [2026-04-10-recon-explanation-layer](../workspaces/black-box/2026-04-10-recon-explanation-layer.md) 吸收 `CopyMark` 现实边界与频域解释层，并把黑盒固定包压成高层可直接复述的 decision-grade package
